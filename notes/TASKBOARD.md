...
| T2 | Orchestrator hardening (loud failures, per-agent events) | qa-pending | notes/evidence/T2-worker.md (agent_started/agent_finished ×7 + run_failed; 171 tests green) |
