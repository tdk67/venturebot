...
| T4 | Rate limits & caps | qa-pending | T4-worker.md: S1/S10 in-memory per-IP limits (concurrent-exec + hourly + 32KB body + SSE cap) enforced in dashboard; 8 tests green, full suite 185 |
